<template>
    <div
        ...
        class="bg-white inline-block rounded hover:shadow-[0_0_10px_3px_rgba(0, 0, 0, 0.15)] cuesor-pointer"
    >
    <NuxtLink :to="`/item/${product.id}`">
        ...
        <div id="ProductDetails">
            ...
            <span class="px-1 relative top-1.5 text-[#ff6674] text-sm font-semibold">
                Extra 5% off
            </span>
            ...
            <p class="flex items0center px-1 pt-0.5 text-xs text-[#252525]">
